...
@section('content')
    <div class="carousel slide" id="myCarousel" data-bs-ride="carousel">
        <div class="carousel-indicators">
            <button class="active" data-bs-target="#myCarousel" data-bs-slide-to="0" type="button" aria-current="true"
                aria-label="Slide 1"></button>
            <button data-bs-target="#myCarousel" data-bs-slide-to="1" type="button" aria-label="Slide 2"></button>
            <button data-bs-target="#myCarousel" data-bs-slide-to="2" type="button" aria-label="Slide 3"></button>
        </div>
        <div class="carousel-inner">
            <div class="carousel-item active">
                <svg class="bd-placeholder-img" aria-hidden="true" width="100%" height="100%"
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-4">
                <svg class="bd-placeholder-img rounded-circle" role="img" aria-label="Placeholder" width="140"
                    height="140" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice"
                    focusable="false">
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5">
                <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" role="img"
                    aria-label="Placeholder: 500x500" width="500" height="500" xmlns="http://www.w3.org/2000/svg"
