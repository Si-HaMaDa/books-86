...
@section('title', 'Admin Area | Edit Hashtag')

@section('content')

    <div class="page-content card">
        <form class="row g-3 card-body" action="{{ route('admin.hashtags.update', $hashtag->id) }}" method="POST">
            @method('PUT')
            @csrf
            ...
            <div class="col-12">
                ...
                <input class="form-control @error('name') is-invalid @enderror" id="inputName" name="name" type="text"
                    value="{{ old('name', $hashtag->name) }}" placeholder="Name...">
                @error('name')
